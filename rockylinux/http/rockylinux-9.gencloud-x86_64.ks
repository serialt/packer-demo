# RockyLinux 9 kickstart file for Generic Cloud (OpenStack) x86-64-v2 image

url --url https://mirror.sjtu.edu.cn/rocky/9/BaseOS/x86_64/kickstart/
repo --name=BaseOS --baseurl=https://mirror.sjtu.edu.cn/rocky/9/BaseOS/x86_64/os/
repo --name=AppStream --baseurl=https://mirror.sjtu.edu.cn/rocky/9/AppStream/x86_64/os/
