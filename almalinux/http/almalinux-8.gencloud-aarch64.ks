...
url --url https://mirror.sjtu.edu.cn/almalinux/8/BaseOS/aarch64/kickstart/
repo --name=BaseOS --baseurl=https://mirror.sjtu.edu.cn/almalinux/8/BaseOS/aarch64/os/
repo --name=AppStream --baseurl=https://mirror.sjtu.edu.cn/almalinux/8/AppStream/aarch64/os/
